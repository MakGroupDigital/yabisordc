    ...
    <div className="relative h-screen w-full overflow-hidden bg-transparent">
      ...
      <div className="fixed top-0 left-0 right-0 z-40 bg-white/90 backdrop-blur-md border-b border-[#003366]/10">
        <div className="container mx-auto px-4 py-4 max-w-2xl">
          ...
          <p className="text-sm text-gray-500 mt-1">Gestion de vos réservations et rendez-vous</p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 py-6 max-w-2xl">
          ...
          >
            ...
            <p className="text-gray-500 text-center mb-6">
              Vous n'avez pas encore de réservation. Découvrez nos services et réservez maintenant.
            </p>
